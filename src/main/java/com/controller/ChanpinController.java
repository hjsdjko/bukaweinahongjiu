    ...
    */
    ...
    public R save(@RequestBody ChanpinEntity chanpin, HttpServletRequest request){
        ...
        Wrapper<ChanpinEntity> queryWrapper = new EntityWrapper<ChanpinEntity>()
            ...
            .eq("chanpin_jinghanlinag", chanpin.getChanpinJinghanlinag())
            .eq("chanpin_baozhiqi", chanpin.getChanpinBaozhiqi())
            .eq("chanpin_peiliao", chanpin.getChanpinPeiliao())
            .eq("chanpin_changhe", chanpin.getChanpinChanghe())
            ;
